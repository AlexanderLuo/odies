...
public interface JedisTemplate<T> {
    ...
    void pipeSadd(String key, List<String> members);

    void pipeZadd(String key, double score, List<String> members);

    void pipeZadd(String key,List<Map<Long,Long>> mapList);
    ...
    /**
     * Description: 管道批量删除 set
     *
     * @author : Evan  Date: 2019/3/29
     * version : 6.4.1.2
     */
    void pipeSrem(String key, Collection<String> keys);
    ...
    List<String> srandmember(String key, Integer size);
}
